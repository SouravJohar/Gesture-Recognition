        ...
        if(MainFrame.capture.isOpened()){
            while(true){
                ...
                if(!webCamImage.empty()){
                    ...
                    try(FileWriter writer = new FileWriter("NirBrightness.txt", true)){//continually writes the value of the brightness onto text file 
                    ...
                    try(FileWriter writer = new FileWriter("NirVolume.txt", true)){//continually writes the value of volume onto the text file
